...
describe("PlaceOrderUseCase unit test", () => {
    ...
    describe("validateProducts method", () => {
        ...
        it("should trown an error when product is out of stock", async () => {
            const mockProductFacade = {
                checkStock: jest.fn(
                    ({ productId }: { productId: string }) => Promise.resolve({
                        productId,
    ...
    describe("execute method", () => {
        ...
        it("Should throw an error when products are not valid", async () => {
            ...
            expect(mockValidadeProduct).toHaveBeenCalledTimes(1);
        });
        ...
        describe("Place an order", () => {
            ...
            it("should not be approved", async () => {
                ...
                expect(mockValidadeProducts).toHaveBeenLastCalledWith(input);
